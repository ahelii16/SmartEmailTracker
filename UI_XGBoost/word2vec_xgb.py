...
def inp(emailto, emailfrom, subj, bod):
    ...
    #print(y_pred)
    return le.inverse_transform(y_pred - 1)[0] , ID

#print(inp("fvf", "defrfg", "payment processed", "hi, the payment for acc 1234 for usd 3456 was paid successfully."))
#print(inp("abc@abc.com", "def@def.com", "payment 1234 processed", "hi, the payment for acc 1234 for usd 3456 was paid successfully."))
